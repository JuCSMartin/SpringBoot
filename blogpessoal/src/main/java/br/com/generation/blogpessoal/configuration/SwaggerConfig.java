...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Blog da Ju")
			.description("Projeto API Spring - Blog Pessoal - Módulo II - Generation Brasil")
			.version("1.0.0")
	...
	private static Contact contact() {
		...
		return new Contact("Juliana Martinez", "https://github.com/JuCSMartin", "julianacmsantos@gmail.com");
